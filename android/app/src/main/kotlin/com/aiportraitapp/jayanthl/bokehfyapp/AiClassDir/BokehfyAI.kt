...
import com.aiportraitapp.jayanthl.bokehfyapp.AsyncHandler
...
class BokehfyAI(mContext: Activity) {
                       ...
                       try {
                           ...
                           interpreter!!.run(inputs, inputOutputOptions)
                                   .addOnSuccessListener { result ->
                                       ...
                                       }, mContext, pendingIntentResult).execute()
                                   }
                           ...
                           Log.i("TensorflowLite", "Inited inference")
                           return@AsyncHandler true
                       } catch (e: Exception) {
                           val resultList = ArrayList<String>()
                           resultList.add("failure")
