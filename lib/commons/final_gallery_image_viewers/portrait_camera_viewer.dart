...
class PortraitCameraViewPage extends StatefulWidget {
  @override
  _PortraitCameraViewPageState createState() => _PortraitCameraViewPageState();
}

class _PortraitCameraViewPageState extends State<PortraitCameraViewPage> {
